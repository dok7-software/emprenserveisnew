          ...
          <div className="max-w-2xl">
            <div className="space-y-6">
              ...
              <div className="animate-on-scroll">
                <h3 className="font-clash font-semibold text-xs text-empren-text/60 mb-3 uppercase tracking-wide">
                  FINANCIADO POR:
                </h3>
                <div className="flex flex-wrap items-center gap-4">
                  {/* EU Logo */}
                  <div className="flex items-center gap-2 group/sponsor">
                    <div className="w-12 h-8 bg-blue-900 rounded flex items-center justify-center group-hover/sponsor:scale-105 transition-transform duration-300 shadow-md">
                      <img 
                        src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=80&h=50&fit=crop" 
                    ...
                    <div>
                      <p className="font-poppins text-xs text-empren-text/70 leading-tight">
                        <span className="font-medium text-empren-text">Unión Europea</span>
                      </p>
                    </div>
                  </div>
