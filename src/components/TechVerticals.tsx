      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-on-scroll">
          <h2 className="font-clash font-bold text-4xl md:text-5xl text-empren-text mb-6">
            Verticales <span className="text-empren-purple relative inline-block">
              Tecnológicas
          ...
          {verticals.map((vertical, index) => (
            <Card key={index} className="hover-card group border-0 bg-white overflow-hidden relative">
              <CardContent className="p-8 text-center relative z-10">
                ...
                <p className="font-poppins text-empren-text/70 text-sm leading-relaxed group-hover:text-empren-text transition-colors duration-300">
