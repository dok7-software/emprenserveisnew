...
const RegistrationDesktop = ({ open, setOpen }: { open: boolean; setOpen: (open: boolean) => void }) => {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 animate-on-scroll">
            ...
            <p className="font-poppins text-xl text-empren-text/70">
              {lang === 'cat'
                ? "No perdis l'oportunitat de formar part de l'ecosistema emprenedor més dinàmic d'Europa"
